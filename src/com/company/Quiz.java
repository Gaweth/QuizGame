...
public class Quiz implements ActionListener {
    ...
    String[] questions = {
            "wchich company created java?",
            "which year was java created?",
            "what was java orginaly called?",
            "who is crredited with creating java?"
    };

    String[][] options = {
            {"sun micro", "starbucks", "microsoft", "alphabet"},
            {"1989", "1996", "1972", "1492"},
    ...
    public void result() {
        ...
        double result = ((correntNumberOfGueasses/(double)totalQuestions)*100);
        ...
        number_right.setText(correntNumberOfGueasses+"/" + totalQuestions);
